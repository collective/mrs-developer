...
const fallbackToDefaultBranch = args.indexOf('--fallback-to-default-branch') > -1 || args.indexOf('--default-to-master') > -1;
...
develop({ noFetch, configFile, noConfig, output, reset, lastTag, https, fetchHttps, fallbackToDefaultBranch, forceDefaultBranch });
